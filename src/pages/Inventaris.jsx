      ...
      <div className="px-12 py-10 flex-1">
        ...
        <div className="grid grid-cols-4 gap-6 mb-10">
          ...
          <div
            ...
            className="bg-white border border-orange-300 rounded-xl p-6 flex justify-between items-center cursor-pointer hover:shadow-lg hover:border-orange-400 transition"
          >
            <div>
